  ...
  <!-- //////////////////////////////////////custome view////////////////////////////////////////// -->
          ...
          <div class="card">
            <div class="card-header">
               <a href="{{url('/hod/salary/request')}}" class="col-md-2 btn btn-block btn-primary float-right">Request Advance</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      @elseif ($show->approve1 == 1 || $show->approve2 == 2 || $show->approve1 == 2)
