          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <label>Created By</label>
                <input type="text" class="form-control" readonly value="{{ $settlmnt != ''? $settlmnt[0]->fcredby:''}}{{ $settlmnt != ''? $settlmnt[0]->lcredby:''}}">
              </div>
              </div>
              <div class="col-md-6">
              <div class="form-group">
              <label>Creaeted Date</label>
                <input type="text" class="form-control" readonly value="{{ $settlmnt[0] != ''? $settlmnt[0]->cdate: ''}}">
              </div>
              </div>
            </div>
            <div class="row">
            <div class="col-md-6">
              ...
              <label>Approved By</label>
                <input type="text" class="form-control" readonly value="{{ $settlmnt != ''? $settlmnt[0]->afcredby:''}} {{ $settlmnt!= ''? $settlmnt[0]->alcredby:''}}">
              </div>
              </div>
              <div class="col-md-6">
              <div class="form-group">
              <label>Approved Date</label>
                <input type="text" class="form-control" readonly value="{{ $settlmnt!= ''? $settlmnt[0]->adate:''}}">
              </div>
              </div>
            </div>
            <input type="hidden" class="form-control" name="bgid" id="bgid" autocomplete="off" value="{{ $settlmnt!= ''? $settlmnt[0]->id:''}}">
            <div class="row">
              <div class="col-md-12">
                <table class="table">
                  <thead>
