      ...
      <div class="container-fluid">
        ...
        <div class="card card-secondary">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <form action="approve/{{$note1[0]->id}}" method="post">
                    {{csrf_field()}}
                <div class="form-group">
                  <label>Department</label>
                  <select class="form-control" style="width: 100%" readonly="" name="department">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label>Note</label>
                  <textarea class="form-control" readonly="" name="note">{{$note1[0]->note}}</textarea>
             ...
             <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="" readonly="" value="{{$note1[0]->reg_no}}">
                ...
                <div class="form-group">
                  <label>Department</label>
                  <input type="text" class="form-control" name="" readonly="" value="{{$note1[0]->department}}">
                  <!-- <textarea class="form-control" name="note">{{$note1[0]->reg_no}}</textarea> -->
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="" readonly="" value="{{$note1[0]->date}}">
                  <!-- <textarea class="form-control" name="note">{{$note1[0]->reg_no}}</textarea> -->
