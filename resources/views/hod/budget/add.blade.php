    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default">
          ...
          <div class="card-body">
          <form name="qryform" id="qryform" method="post" action="{{url('hod/budget/save')}}"  novalidate="novalidate">
          {{ csrf_field() }}  
          <div class="row">
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
               ...
               <div class="col-md-6">
                ...
                <a type="button" class="btn btn-danger" href="{{url('hod/budget')}}">Close</a>
             </form>
            </div>
            </div>
          </div>
