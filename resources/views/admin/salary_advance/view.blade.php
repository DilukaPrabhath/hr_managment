          ...
          <div class="card-body">
             ...
             <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>EMP</label>
                  <input type="text" name="emp" class="form-control" readonly="" value="{{$data[0]->reg_no}}">
                  </div>
                </div>
                <div class="col-md-6">
                <div class="form-group">
                  <label>Department</label>
                  <input type="text" name="" class="form-control" readonly="" value="{{$data[0]->department}}">
                  </div>
                </div>
             </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Amount</label>
                  <input type="number" name="amount" class="form-control" readonly="" value="{{$data[0]->amount}}">
                  </div>
                </div>
               <div class="col-md-6">
                <div class="form-group">
                  <label>Deduction Months</label>
                  <input type="number" name="months" class="form-control" readonly="" value="{{$data[0]->months}}">
                  </div>
                 </div>
             </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label>Purpose</label>
                  <textarea class="form-control" readonly="" name="perpose"> {{$data[0]->perpose}}</textarea>
                  ...
                  <textarea class="form-control" name="salary_comments">{{Request::old('salary_comments')}}</textarea>
                   @if($errors->has('salary_comments'))
                                        <div class="" style="padding: 0 !important;">
                                            <span class="">{{$errors->first('salary_comments')}}</span>
                                        </div>
                                    @endif
                  <!-- <input type="text" class="form-control"> -->
                  </div>
            ...
            <select class="form-control" style="width: 100%" name="status">
             ...
             @if($errors->has('status'))
                 <div class="" style="padding: 0 !important;">
                     <span class="">{{$errors->first('status')}}</span>
                 </div>
             @endif
                  </div>
