    ...
    <!-- Main content -->
      ...
      <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <button type="button" class="col-md-2 btn btn-block btn-primary float-left" data-toggle="modal" data-target="#modal-lg2">
                  Add Ammount
                </button>
          ...
          <div class="col-md-12">
            ...
            <div class="timeline">
             ...
             @foreach($data as $show)
              ...
              <a class="btn btn-default float-right" style="margin:  5px;" title="comments"  href="{{url('/admin/salary')}}">Back</a>
            </div>
          </div>
          </div>
      ...
      <div class="modal fade" id="modal-lg2">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Ammount</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="approve_amount/{{$show->salary_advance_id}}" method="post">
                    {{csrf_field()}}
            <div class="modal-body">
              <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" required="" name="salary_approve">
