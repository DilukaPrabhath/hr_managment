    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default">
          ...
          <div class="card-body">
          <form name="qryform" id="qryform" method="post" action="{{ url('admin/employee/update') }}">
          {{ csrf_field() }}
                ...
                <div class="form-group">
                  <label>Status</label>
                    <select class="form-control select" name="stts" id="stts">
                      <option value="1" {{$empData[0]->status=='1'?'selected':''}}>Active</option>
                      <option value="0" {{$empData[0]->status=='0'?'selected':''}}>Inactive</option>
                    </select>
                  </div>
                </div>
               <div class="col-md-6">
