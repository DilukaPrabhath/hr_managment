      ...
      <div class="container-fluid">
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            <hr>
            <form name="qryform" id="qryform" method="post" action="{{url('admin/settelement/approve/save')}}"  novalidate="novalidate">
          {{ csrf_field() }}  
          <div class="row">
            <div class="col-md-6">
            ...
            <input type="hidden" class="form-control" name="stid" id="stid" autocomplete="off" value="{{$settlmnt[0]->id}}">
            <div class="row">
              <div class="col-md-12">
              <table class="table">
                  <thead>
            ...
            <div class="row">
              <div class="col-md-12">
              @if($budgetData['budget'][0]->settlement!=2 && $budgetData['budget'][0]->settlement!=22) <button type="submit" class="btn btn-success">Submit</button>@endif
                <a type="button" class="btn btn-danger" href="{{url('admin/settelements')}}">Close</a>
              </div>
              </div>
            </div>
            </form>
