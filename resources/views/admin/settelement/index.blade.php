                ...
                @foreach($budgetData as $key => $value)
                    ...
                    <td></td>
                      ...
                      <td class="project-actions">
                          <a class="btn btn-info btn-sm" href="{{ url('admin/settelements/preview').'/'.$value->id }}" title="Preview">
                              <i class="fa fa-eye"> </i>
                          </a>
                          @if($value->settlement==1)
                          <a class="btn btn-success btn-sm" href="{{ url('admin/settelement/approve').'/'.$value->id }}" title="Approved">
