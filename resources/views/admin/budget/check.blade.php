  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Budget Request Check</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default">
          ...
          <div class="card-body">
          <form name="qryform" id="qryform" method="post" action="{{url('admin/budget/checksave')}}"  novalidate="novalidate">
          {{ csrf_field() }}  
          ...
          <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                @if($budgetData['budget'][0]->status != 2 && $budgetData['budget'][0]->status != 22)<button type="submit" class="btn btn-success">Submit</button>@endif 
