      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <!--  <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="{{url('/usernote')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('user/salary/advance')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">  
              <li class="nav-item">
                <a href="{{url('/user/budget')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Home</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/user/budget/new')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create New</p>
                </a>
              </li>
        ...
        <!-- /.budget-->
         ...
         <!--  <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/new_employee')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create New</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/layout/Preview.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Preview</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/layout/Edit.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit</p>
                </a>
              </li>
