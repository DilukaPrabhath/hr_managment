             ...
             <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>EMP</label>
                  <input type="text" name="amount" class="form-control" value="{{$data[0]->reg_no}}">
                  </div>
                </div>
                <div class="col-md-6">
                <div class="form-group">
                  <label>Department</label>
                  <input type="text" name="amount" class="form-control" value="{{$data[0]->department}}">
                  </div>
                </div>
             </div>
            ...
            <div class="row">
             ...
             <div class="row">
              <div class="col-md-6">
               ...
               <a class="btn btn-default float-right" style="margin:  5px;" title="comments"  href="{{url('superadmin/salary')}}">
                              Back
                          </a>
                </div>
