  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Budget Request Approved</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card card-default">
          ...
          action="{{url('superadmin/budget/approvesave')}}"  novalidate="novalidate">
          {{ csrf_field() }}  
          <input type="hidden" value="{{$budgetData['budget'][0]->id}}" name="id" id="id">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                @if($budgetData['budget'][0]->status != 3 && $budgetData['budget'][0]->status != 33)<button type="submit" class="btn btn-success">Submit</button>@endif 
                <a type="button" class="btn btn-danger" href="{{url('/superadmin/budget')}}">Close</a>
              </div>
            </div>
            </form>
          </div>
