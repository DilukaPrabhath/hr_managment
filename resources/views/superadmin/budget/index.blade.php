                  ...
                  @foreach($budgetData as $key => $value)
                    <tr>
                      ...
                      <td class="project-actions">
                          <a class="btn btn-info btn-sm" href="{{ url('superadmin/budget/preview').'/'.$value->id }}" title="Preview">
                              <i class="fa fa-eye"> </i>
                          </a>
                          <a class="btn btn-success btn-sm" href="{{ url('superadmin/budget/approve').'/'.$value->id }}" title="Approved">
