     ...
     <div class="col-12">
          <div class="card">
            <div class="card-header">
               <a href="{{url('/user/budget/new')}}" class="col-md-1 btn btn-block btn-primary float-right">New</a>
            </div>
            <div class="card-body">
                  ...
                  @foreach($budgetData as $key => $value)
                    ...
                    <td></td>
                      ...
                      <td class="project-actions">
                          <a class="btn btn-info btn-sm" href="{{ url('user/budget/preview').'/'.$value->id }}" title="Preview">
                              <i class="fa fa-eye"> </i>
                          </a>
                          @if($value->status==1)
                          <a class="btn btn-warning btn-sm" href="{{ url('user/budget/edit').'/'.$value->id }}" title="Edit">
