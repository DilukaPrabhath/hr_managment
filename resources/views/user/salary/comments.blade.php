          ...
          <div class="col-md-12">
            ...
            <div class="timeline">
              ...
              <div class="time-label">
                <span class="bg-red">Time Line</span> <span class="bg-blue">Requested Amount : {{$comment[0]->requested_sal_advance}}</span> <span class="bg-blue">Approved Amount : {{$comment[0]->approve_sal_advance}}</span>
              </div>
              <!-- /.timeline-label -->
              <!-- timeline item -->
               <!-- /.timeline-label -->
             @foreach($comment as $show)
              <div>
              ...
              <a class="btn btn-default float-right" style="margin:  5px;" title="comments"  href="{{url('/user/salary/advance')}}">Back</a>
            </div>
          </div>
          </div>
